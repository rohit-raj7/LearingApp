    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>
            Course by <span className='text-blue-600 underline'>FeelWinner</span>
          </p>
        ...
        {/* Right Column */}
        <div className='max-w-course-card z-10 shadow-lg border border-gray-200 rounded-6 md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          {playerData ? (
            <YouTube
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-4 text-gray-500'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <p>{calucalteNoOfLectures(courseData)}</p>
              </div>
            </div>
